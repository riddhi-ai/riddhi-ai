...
- Medication and symptom correlation
- Doctor-ready health reports
- Multi-profile caregiver support
...
- Dental treatment and service information
- Doctor profiles
- A multi-step appointment booking process
- Responsive design
- Google Maps integration
- Interactive treatment sections

**Built with:** React.js, JavaScript, Tailwind CSS and Vite.
